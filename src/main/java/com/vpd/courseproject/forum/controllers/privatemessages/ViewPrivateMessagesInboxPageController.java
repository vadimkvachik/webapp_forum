...
/**
 * Shows the user's private messages.
 */
@WebServlet("/private_in")
public class ViewPrivateMessagesInboxPageController extends HttpServlet {
    private static final Logger logger = Logger.getLogger(ViewPrivateMessagesInboxPageController.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        if (sessionUser != null) {
            try {
                req.setAttribute("messages", privateMessageService.getPrivateMessagesByRecipient(sessionUser.getLogin()));
                req.getRequestDispatcher("/privateMessagesInboxPage.jsp").forward(req, resp);
